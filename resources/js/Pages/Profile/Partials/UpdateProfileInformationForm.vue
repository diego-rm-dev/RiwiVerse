    ...
    <FormSection @submitted="updateProfileInformation">
        ...
        <template #form>
            ...
            <div v-if="$page.props.jetstream.managesProfilePhotos"
                class="col-span-6 sm:col-span-4 flex flex-col justify-center">
                ...
                <SecondaryButton class="mt-2 me-2 sidebar-btn publish-btn" type="button"
                    @click.prevent="selectNewPhoto">
                    Select A New Photo
                </SecondaryButton>

                <SecondaryButton v-if="user.profile_photo_path" type="button" class="mt-2 sidebar-btn publish-btn"
